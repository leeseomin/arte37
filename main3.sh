...
cd ..
cd s9
parallel convert {}  -set filename:new  ../s25/"%tz37a" "%[filename:new].png" ::: *.*
cd ..
cd s9
for i in *.* 
do 
...
cd s6
for i in *.*; do
   convert $i  -set filename:new ../s25/"%tz37b" "%[filename:new].png"
done
cd ..
cd s6
for i in *.*
...
cd ..
cd s15
parallel convert {}  -set filename:new  ../s25/"%tz37c" "%[filename:new].png" ::: *.*
cd ..
cd s15
for i in *.*
do
...
cd ..
cd s17
parallel convert {}  -set filename:new  ../s25/"%tz37d" "%[filename:new].png" ::: *.*
cd ..
cd s17
for i in *.*; do
...
cd s2
for i in *.*; do
   convert $i  -set filename:new ../s25/"%tz37e" "%[filename:new].png"
done
cd ..
cd s9
for i in *.*
...
cd ..
cd s17
parallel convert {}  -set filename:new  ../s25/"%tx37a" "%[filename:new].png" ::: *.*
cd ..
cd s17
for i in *.*; do
convert  $i -set option:size '%[fx:min(w,h)]x%[fx:min(w,h)]' xc:none +swap -gravity center -composite -resize 3000x3000 $i 
...
cd s2
for i in *.*; do
   convert $i  -set filename:new ../s25/"%tx37c" "%[filename:new].png"
done
cd .. 
cd s2
parallel gmic {} -fx_array_mirror 1,0,0,2,0,0,0 -o ../s3/{} ::: *.* 
cd ..
cd s3
for i in *.*; do
   convert $i  -set filename:new ../s25/"%tx37cm" "%[filename:new].png"
done
cd ..
cd s3
for i in *.*
do
convert -gravity Center -crop 84% $i $i
done
cd ..
cd s3
for i in *.*; do
   convert $i  -set filename:new ../s25/"%tx37cm2" "%[filename:new].png"
done
